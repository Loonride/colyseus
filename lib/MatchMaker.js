...
class MatchMaker {
    ...
    onJoinRoomRequest(client, roomToJoin, clientOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let sessionId = clientOptions.sessionId;
            ...
            if (index_1.isValidId(roomId)) {
                roomId = yield this.joinById(roomId, clientOptions, isReconnect && sessionId);
            }
    ...
    getRoomsWithScore(roomName, clientOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield Promise.all(remoteRequestJoins)).filter(elem => elem !== false).concat(roomsWithScore);
        });
    }
